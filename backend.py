...
# --- CONFIGURAÇÃO VISUAL ---
st.set_page_config(page_title="Monitor Corp V34", page_icon="🏢", layout="wide")
...
def render_grafico_comparativo(df_a, df_b):
    ...
    fig.update_layout(title="Volume de Avaliações", barmode='group', height=300, paper_bgcolor='rgba(0,0,0,0)', plot_
